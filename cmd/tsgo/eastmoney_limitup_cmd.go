...
// NewEastmoneyLimitupAPICmd returns the root command
func NewEastmoneyLimitupAPICmd() *cobra.Command {

	var logLevel string

	rootCmd := &cobra.Command{
		Use:   "emlu",
		Short: `Fetch finance from eastmoney Limitup API`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			//}
			screen := TerminalStocks.NewScreen(TerminalStocks.API_VENDOR_LIMITUP_EASTMONEY)
			defer screen.Close()

			profile := TerminalStocks.NewProfile(TerminalStocks.API_VENDOR_LIMITUP_EASTMONEY)
